...
function App() {
  return (
    <div className=" font-inconsolata text-white w-full min-h-screen  bg-mobile md:bg-tablet xl:bg-tablet bg-cover">
      <div className=" border border-red-600 w-full  max-w-[1440px] mx-auto min-h-full bg-lines py-12 md:pt-8 relative">
